...
import {
  LayoutDashboard, Ticket, ShoppingCart, Users, Settings2, Menu, X, ChevronRight, Home, Cog, Gift, UserPlus,
} from "lucide-react";
             ...
             <div className="relative flex min-w-0 flex-1 flex-col">
               ...
               >
                  <div className="mx-auto grid max-w-4xl grid-cols-3 gap-1 sm:grid-cols-6">
                     {ADMIN_NAV.filter(({ to }) => ["/admin/plans", "/admin/inventory", "/admin/purchases", "/admin/users", "/admin/bonus", "/admin/referrals"].includes(to)).map(({ label, to, icon: Icon }) => {
