...
import { Save, Globe, MessageCircle, Settings2, Wifi, KeyRound, Eye, EyeOff, Pencil, CheckCircle2, XCircle, ImagePlus, WalletCards } from "lucide-react";
...
export default function AdminSettings() {
  ...
  const tabs = [{ id: "general", label: "General", icon: Settings2 }, { id: "payment", label: "Payment", icon: Globe }, { id: "logos", label: "Site logo", icon: ImagePlus }, { id: "funding", label: "Manual funding", icon: WalletCards }] as const;
